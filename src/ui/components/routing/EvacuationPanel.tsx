...
export function EvacuationPanel({ context = 'evacuation' }: { context?: 'general' | 'evacuation' }) {
  ...
  const pickDestClass = (active: boolean) =>
    `flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border transition ${active ? 'border-[#5500a4] bg-[#5500a4] text-white' : 'border-white/10 bg-white/5 text-slate-300 hover:bg-white/10 md:border-[#00d890]/30 md:bg-[#00d890]/15 md:text-[#00d890] md:hover:bg-[#00d890]/20 md:hover:text-[#00d890]'}`;
      ...
      <div>
        ...
        <div className="mb-2 flex items-center gap-2">
          ...
          <button
            ...
            className={pickStartClass(pickMode === 'start')}
          >
        ...
        <div className="mb-3 flex items-center gap-2">
          ...
          <button
            ...
            className={pickDestClass(pickMode === 'destination')}
          >
            <MapPin className="h-4 w-4" />
          </button>
          {destination && (
